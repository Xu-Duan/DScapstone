...
def get_scatter_chart(entered_site, payload_range):
    ...
    fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title='Payload vs. Success for All Sites' if entered_site == 'ALL' else f'Payload vs. Success for {entered_site}')
    return fig
